...
// _addTicketIdToDetails :: StockCompany -> List Number -> StockCompanyWithId
...
// _updateKeys :: StockCompanyWithId -> StockPriceApi -> StockPriceInsert
...
// _insertPrice ::
// Knex -> StockCompanyWithId -> List StockPriceApi -> List (List Number)
...
// _getAndInsertHistory :: Knex -> StockCompanyWithId -> List Number
...
// _saveAndGetHistory :: Knex -> StockCompany -> List Number
...
// seedStockData :: Knex -> List StockCompany -> I/O
